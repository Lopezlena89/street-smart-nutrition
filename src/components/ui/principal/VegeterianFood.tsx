            ...
            <div className="w-full h-auto  grid grid-cols-2 md:grid-cols-3  z-0">
                <div className="m-1 w-full h-full z-0">
                    <Card shadow="sm" isPressable onPress={() => console.log("item pressed")}>
                        <NavLink to="/recipes/Receta fácil de arroz cremoso con espinacas en una olla" className=" w-full h-full">
                            <CardBody className="overflow-visible p-0">
                                ...
                                src={`/assets/Creamy-Spinach-Rice-8-728x1092.webp`}
                                />
                            </CardBody>
                        </NavLink>
                ...
                <div className="m-1 w-full h-full z-0">
                    <Card shadow="sm" isPressable onPress={() => console.log("item pressed")}>
                        <NavLink to="/recipes/Ensalada Verde con Lentejas y Verduras Asadas" className=" w-full h-full">
                            <CardBody className="overflow-visible p-0">
                                <Image
                                shadow="sm"
                                radius="lg"
                                ...
                                className="w-[95%] m-1 object-cover h-[500px]  md:h-[500px]"
                                src={`/assets/Lentil-Salad-11-e1689634222880-728x1092.webp`}
                                />
                            </CardBody>
                        </NavLink>
                        <CardFooter className="text-small justify-between min-h-[100px]">
                ...
                <div className="m-1 w-full h-full z-0">
                    <Card shadow="sm" isPressable onPress={() => console.log("item pressed")}>
                        <NavLink to="/recipes/Ensalada De Cuscús Perlado Con Aderezo De Limón Y Ajo" className=" w-full h-full">
                            <CardBody className="overflow-visible p-0">
                                <Image
                                shadow="sm"
                                radius="lg"
                                ...
                                className="w-[95%] m-1 object-cover h-[500px]  md:h-[500px]"
                                src={`/assets/CA-Walnuts-Salad-11-728x1092.webp`}
                                />
                ...
                <div className="m-1 w-full h-full z-0">
                    <Card shadow="sm" isPressable onPress={() => console.log("item pressed")}>
                        <NavLink to="/recipes/Tofu crujiente de naranja y edamame (salteado vegano)" className=" w-full h-full">
                            <CardBody className="overflow-visible p-0">
                                <Image
                                shadow="sm"
                                radius="lg"
                                ...
                                className="w-[95%] m-1 object-cover h-[500px]  md:h-[400px]"
                                src={`/assets/Orange-Tofu-and-Edamame-Stir-Fry-18-728x1092.webp`}
                                />
                            </CardBody>
                        </NavLink>
                        <CardFooter className="text-small justify-between min-h-[100px]">
                ...
                <div className="m-1 w-full h-full z-0">
                    <Card shadow="sm" isPressable onPress={() => console.log("item pressed")}>
                        <NavLink to="/recipes/Ramen fácil de microondas con huevos: ¡los huevos para la cena ya están aquí!" className=" w-full h-full">
                            <CardBody className="overflow-visible p-0">
                                <Image
                                shadow="sm"
                                radius="lg"
                                ...
                                className="w-[95%] m-1 object-cover h-[500px]  md:h-[400px]"
                                src={`/assets/Easy-Homemade-Ramen-with-Eggs-4-728x1092.webp`}
                                />
                            </CardBody>
                        </NavLink>
                        <CardFooter className="text-small justify-between min-h-[100px]">
