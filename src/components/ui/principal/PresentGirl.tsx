    ...
    <>
        <div className="w-full h-[800px] bg-gray-100 flex items-center  lg:h-[600px]">
            <div className="w-full h-[90%] flex flex-col p-5 lg:flex-row  ">
                <div className="w-full h-full xl:w-3/6 bg-[url('/assets/home-intuitive-eating.png')] bg-center bg-cover bg-no-repeat"/>
                <div className="w-full h-full xl:w-2/6 bg-white flex flex-col justify-center p-5">
                    ...
                    <NavLink to="#" className="mt-5 w-[180px] h-[40px] bg-black text-white flex justify-center items-center">Ver mas articulos</NavLink>
