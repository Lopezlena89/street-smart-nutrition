                ...
                <div className="m-1 w-full h-full z-0">
                    <Card shadow="sm" isPressable onPress={() => console.log("item pressed")}>
                        <CardBody className="overflow-visible p-0">
                            ...
                            src={`/assets/IMG_5888-728x1092.png`}
                            />
                        </CardBody>
                ...
                <div className="m-1 w-full h-full z-0">
                    <Card shadow="sm" isPressable onPress={() => console.log("item pressed")}>
                        <CardBody className="overflow-visible p-0">
                            ...
                            radius="lg"
                            width="100%"
                            alt="FAvena nocturna con arándanos y coco"
                            className="w-[95%] m-1 object-cover h-[500px]  md:h-[500px]"
                            src={`/assets/Blueberry-Coconut-Overnight-Oats-2-1-728x1092.png`}
                            />
                        </CardBody>
                        <CardFooter className="text-small justify-between min-h-[100px]">
                ...
                <div className="m-1 w-full h-full z-0">
                    <Card shadow="sm" isPressable onPress={() => console.log("item pressed")}>
                        <CardBody className="overflow-visible p-0">
                            ...
                            className="w-[95%] m-1 object-cover h-[500px]  md:h-[500px]"
                            src={`/assets/Edamame-Dip-24-728x1092.png`}
                            />
                        </CardBody>
                        <CardFooter className="text-small justify-between min-h-[100px]">
                ...
                <div className="m-1 w-full h-full z-0">
                    <Card shadow="sm" isPressable onPress={() => console.log("item pressed")}>
                        <CardBody className="overflow-visible p-0">
                            ...
                            src={`/assets/Yogurt-Marinated-Chicken-Kebabs-7-728x1092.png`}
                            />
                        </CardBody>
                        <CardFooter className="text-small justify-between min-h-[100px]">
                ...
                <div className="m-1 w-full h-full z-0">
                    <Card shadow="sm" isPressable onPress={() => console.log("item pressed")}>
                        <CardBody className="overflow-visible p-0">
                            ...
                            className="w-[95%] m-1 object-cover h-[500px]  md:h-[400px]"
                            src={`/assets/Sweet-Miso-Pork-Stir-Fry-12-728x1092.png`}
                            />
                        </CardBody>
                        <CardFooter className="text-small justify-between min-h-[100px]">
                ...
                <div className="m-1 w-full h-full z-0">
                    <Card shadow="sm" isPressable onPress={() => console.log("item pressed")}>
                        <CardBody className="overflow-visible p-0">
                            ...
                            className="w-[95%] m-1 object-cover h-[500px]  md:h-[400px]"
                            src={`/assets/tuna-veggie-cups-5-728x1092.png`}
                            />
                        </CardBody>
                        <CardFooter className="text-small justify-between min-h-[100px]">
